...
void platform_list_u32_free(platform_list_u32_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void wasi_http_types_method_free(wasi_http_types_method_t *ptr) {
  switch ((int32_t) ptr->tag) {
    case 9: {
      platform_string_free(&ptr->val.other);
      break;
    }
  }
}
...
void platform_option_string_free(platform_option_string_t *ptr) {
  if (ptr->is_some) {
    platform_string_free(&ptr->val);
  }
}

void platform_option_u16_free(platform_option_u16_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_dns_error_payload_free(wasi_http_types_dns_error_payload_t *ptr) {
  platform_option_string_free(&ptr->rcode);
  platform_option_u16_free(&ptr->info_code);
}

void platform_option_u8_free(platform_option_u8_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_tls_alert_received_payload_free(wasi_http_types_tls_alert_received_payload_t *ptr) {
  platform_option_u8_free(&ptr->alert_id);
  platform_option_string_free(&ptr->alert_message);
}

void platform_option_u32_free(platform_option_u32_t *ptr) {
  if (ptr->is_some) {
  }
}

void wasi_http_types_field_size_payload_free(wasi_http_types_field_size_payload_t *ptr) {
  platform_option_string_free(&ptr->field_name);
  platform_option_u32_free(&ptr->field_size);
}

void platform_option_u64_free(platform_option_u64_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void wasi_http_types_error_code_free(wasi_http_types_error_code_t *ptr) {
  switch ((int32_t) ptr->tag) {
    ...
    case 17: {
      platform_option_u64_free(&ptr->val.http_request_body_size);
      break;
    }
    case 21: {
      platform_option_u32_free(&ptr->val.http_request_header_section_size);
      break;
    }
    case 22: {
    ...
    case 23: {
      platform_option_u32_free(&ptr->val.http_request_trailer_section_size);
      break;
    }
    case 24: {
    ...
    case 26: {
      platform_option_u32_free(&ptr->val.http_response_header_section_size);
      break;
    }
    case 27: {
    ...
    case 28: {
      platform_option_u64_free(&ptr->val.http_response_body_size);
      break;
    }
    case 29: {
      platform_option_u32_free(&ptr->val.http_response_trailer_section_size);
      break;
    }
    case 30: {
    ...
    case 31: {
      platform_option_string_free(&ptr->val.http_response_transfer_coding);
      break;
    }
    case 32: {
      platform_option_string_free(&ptr->val.http_response_content_coding);
      break;
    }
    case 38: {
      platform_option_string_free(&ptr->val.internal_error);
      break;
    }
  }
}
...
void platform_tuple2_field_key_field_value_free(platform_tuple2_field_key_field_value_t *ptr) {
  wasi_http_types_field_key_free(&ptr->f0);
  wasi_http_types_field_value_free(&ptr->f1);
}

void platform_list_tuple2_field_key_field_value_free(platform_list_tuple2_field_key_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
    platform_tuple2_field_key_field_value_t *list_ptr = ptr->ptr;
    for (size_t i = 0; i < list_len; i++) {
      platform_tuple2_field_key_field_value_free(&list_ptr[i]);
    }
    free(list_ptr);
  }
}
...
void platform_list_field_value_free(platform_list_field_value_t *ptr) {
  size_t list_len = ptr->len;
  if (list_len > 0) {
...
void platform_option_duration_free(platform_option_duration_t *ptr) {
  if (ptr->is_some) {
  }
}
...
void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, platform_list_u32_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_poll_poll((uint8_t *) (*in).ptr, (*in).len, ptr);
  *ret = (platform_list_u32_t) { (uint32_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, platform_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_io_error_method_error_to_debug_string((self).__handle, ptr);
  *ret = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, platform_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, platform_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          platform_option_string_t option;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option.is_some = true;
              option.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u16_t option0;
        ...
        case 14: {
          ...
          platform_option_string_t option2;
          switch ((int32_t) *((uint8_t*) (ptr + 20))) {
            ...
            case 1: {
              ...
              option2.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
              break;
            }
          }
        ...
        case 22: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              ...
              platform_option_string_t option5;
              switch ((int32_t) *((uint8_t*) (ptr + 20))) {
                case 0: {
                ...
                case 1: {
                  ...
                  option5.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
                  break;
                }
              }
              platform_option_u32_t option6;
        ...
        case 24: {
          platform_option_string_t option9;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option9.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u32_t option10;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 26: {
          platform_option_u32_t option11;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
        ...
        case 27: {
          platform_option_string_t option12;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option12.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u32_t option13;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 28: {
          platform_option_u64_t option14;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
        ...
        case 29: {
          platform_option_u32_t option15;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
        ...
        case 30: {
          platform_option_string_t option16;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option16.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u32_t option17;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
        ...
        case 31: {
          platform_option_string_t option18;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option18.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 32: {
          platform_option_string_t option19;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option19.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 38: {
          platform_option_string_t option20;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option20.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
...
void wasi_http_types_static_fields_from_list(platform_list_tuple2_field_key_field_value_t *entries, wasi_http_types_result_own_fields_header_error_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, platform_list_field_value_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_get((self).__handle, (uint8_t *) (*name).ptr, (*name).len, ptr);
  *ret = (platform_list_field_value_t) { (wasi_http_types_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, platform_list_field_value_t *value, wasi_http_types_result_void_header_error_t *ret) {
...
void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, platform_list_tuple2_field_key_field_value_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_fields_entries((self).__handle, ptr);
  *ret = (platform_list_tuple2_field_key_field_value_t) { (platform_tuple2_field_key_field_value_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
...
void wasi_http_types_method_incoming_request_method(wasi_http_types_borrow_incoming_request_t self, wasi_http_types_method_t *ret) {
  ...
  switch ((int32_t) variant.tag) {
    ...
    case 9: {
      variant.val.other = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 4))), (*((size_t*) (ptr + 8))) };
      break;
    }
  }
  *ret = variant;
...
void wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, platform_option_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      option.is_some = true;
      option.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 4))), (*((size_t*) (ptr + 8))) };
      break;
    }
  }
  *ret = option;
  ...
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    ...
    case 1: {
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 2: {
          variant.val.other = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 8))), (*((size_t*) (ptr + 12))) };
          break;
        }
      }
...
void wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, platform_option_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_outgoing_request_set_method(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_method_t *method, wasi_http_types_result_void_void_t *ret) {
  ...
  switch ((int32_t) (*method).tag) {
    ...
    case 9: {
      const platform_string_t *payload8 = &(*method).val.other;
      variant = 9;
...
void wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *path_with_query, wasi_http_types_result_void_void_t *ret) {
  int32_t option;
  uint8_t * option1;
  size_t option2;
  if ((*path_with_query).is_some) {
    const platform_string_t *payload0 = &(*path_with_query).val;
    option = 1;
...
void wasi_http_types_method_outgoing_request_set_scheme(wasi_http_types_borrow_outgoing_request_t self, wasi_http_types_option_scheme_t *scheme, wasi_http_types_result_void_void_t *ret) {
  ...
  if ((*scheme).is_some) {
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 2: {
        const platform_string_t *payload3 = &(*payload0).val.other;
        variant = 2;
...
void wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *authority, wasi_http_types_result_void_void_t *ret) {
  int32_t option;
  uint8_t * option1;
  size_t option2;
  if ((*authority).is_some) {
    const platform_string_t *payload0 = &(*authority).val;
    option = 1;
    option1 = (uint8_t *) (*payload0).ptr;
    option2 = (*payload0).len;
  } else {
...
void wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[16];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_http_types_method_request_options_connect_timeout((self).__handle, ptr);
  platform_option_duration_t option;
  switch ((int32_t) *((uint8_t*) (ptr + 0))) {
    case 0: {
      option.is_some = false;
      break;
...
void wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret) {
  int32_t option;
  int64_t option1;
  if ((*duration).is_some) {
...
void wasi_http_types_method_request_options_first_byte_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[16];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_request_options_set_first_byte_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret) {
  int32_t option;
  int64_t option1;
  if ((*duration).is_some) {
    const wasi_http_types_duration_t *payload0 = &(*duration).val;
...
void wasi_http_types_method_request_options_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[16];
  uint8_t *ptr = (uint8_t *) &ret_area;
...
void wasi_http_types_method_request_options_set_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret) {
  int32_t option;
  int64_t option1;
  if ((*duration).is_some) {
    const wasi_http_types_duration_t *payload0 = &(*duration).val;
    ...
    switch ((int32_t) (*payload0).tag) {
      ...
      case 1: {
        ...
        if (((*payload2).rcode).is_some) {
          const platform_string_t *payload4 = &((*payload2).rcode).val;
          option = 1;
      ...
      case 14: {
        ...
        if (((*payload23).alert_message).is_some) {
          const platform_string_t *payload29 = &((*payload23).alert_message).val;
          option30 = 1;
      ...
      case 17: {
        const platform_option_u64_t *payload35 = &(*payload0).val.http_request_body_size;
        int32_t option38;
        int64_t option39;
      ...
      case 21: {
        const platform_option_u32_t *payload43 = &(*payload0).val.http_request_header_section_size;
        int32_t option46;
        int32_t option47;
      ...
      case 22: {
        ...
        if ((*payload48).is_some) {
          ...
          if (((*payload50).field_name).is_some) {
            const platform_string_t *payload52 = &((*payload50).field_name).val;
            option53 = 1;
      ...
      case 23: {
        const platform_option_u32_t *payload66 = &(*payload0).val.http_request_trailer_section_size;
        int32_t option69;
        int32_t option70;
      ...
      case 24: {
        ...
        if (((*payload71).field_name).is_some) {
          const platform_string_t *payload73 = &((*payload71).field_name).val;
          option74 = 1;
      ...
      case 26: {
        const platform_option_u32_t *payload82 = &(*payload0).val.http_response_header_section_size;
        int32_t option85;
        int32_t option86;
      ...
      case 27: {
        ...
        if (((*payload87).field_name).is_some) {
          const platform_string_t *payload89 = &((*payload87).field_name).val;
          option90 = 1;
      ...
      case 28: {
        const platform_option_u64_t *payload97 = &(*payload0).val.http_response_body_size;
        int32_t option100;
        int64_t option101;
      ...
      case 29: {
        const platform_option_u32_t *payload102 = &(*payload0).val.http_response_trailer_section_size;
        int32_t option105;
        int32_t option106;
      ...
      case 30: {
        ...
        if (((*payload107).field_name).is_some) {
          const platform_string_t *payload109 = &((*payload107).field_name).val;
          option110 = 1;
      ...
      case 31: {
        const platform_option_string_t *payload117 = &(*payload0).val.http_response_transfer_coding;
        int32_t option120;
        uint8_t * option121;
        size_t option122;
        if ((*payload117).is_some) {
          const platform_string_t *payload119 = &(*payload117).val;
          option120 = 1;
      ...
      case 32: {
        const platform_option_string_t *payload123 = &(*payload0).val.http_response_content_coding;
        int32_t option126;
        uint8_t * option127;
        size_t option128;
        if ((*payload123).is_some) {
          const platform_string_t *payload125 = &(*payload123).val;
          option126 = 1;
      ...
      case 38: {
        const platform_option_string_t *payload134 = &(*payload0).val.internal_error;
        int32_t option137;
        uint8_t * option138;
        size_t option139;
        if ((*payload134).is_some) {
          const platform_string_t *payload136 = &(*payload134).val;
          option137 = 1;
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  platform_option_string_t option0;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option0.is_some = false;
                      break;
                    ...
                    case 1: {
                      option0.is_some = true;
                      option0.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u16_t option1;
                ...
                case 14: {
                  ...
                  platform_option_string_t option3;
                  switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                    ...
                    case 1: {
                      option3.is_some = true;
                      option3.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                      break;
                    }
                  }
                  variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
                ...
                case 22: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option8.is_some = true;
                      platform_option_string_t option6;
                      switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                        case 0: {
                          option6.is_some = false;
                          break;
                        ...
                        case 1: {
                          option6.is_some = true;
                          option6.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                          break;
                        }
                      }
                      platform_option_u32_t option7;
                ...
                case 24: {
                  platform_option_string_t option10;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option10.is_some = false;
                      break;
                    ...
                    case 1: {
                      option10.is_some = true;
                      option10.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option11;
                ...
                case 26: {
                  platform_option_u32_t option12;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option12.is_some = false;
                      break;
                ...
                case 27: {
                  platform_option_string_t option13;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option13.is_some = false;
                      break;
                    ...
                    case 1: {
                      option13.is_some = true;
                      option13.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option14;
                  switch ((int32_t) *((uint8_t*) (ptr + 44))) {
                    case 0: {
                      option14.is_some = false;
                      break;
                ...
                case 28: {
                  platform_option_u64_t option15;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option15.is_some = false;
                      break;
                ...
                case 29: {
                  platform_option_u32_t option16;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option16.is_some = false;
                      break;
                ...
                case 30: {
                  platform_option_string_t option17;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option17.is_some = false;
                      break;
                    ...
                    case 1: {
                      option17.is_some = true;
                      option17.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option18;
                  switch ((int32_t) *((uint8_t*) (ptr + 44))) {
                    case 0: {
                      option18.is_some = false;
                      break;
                ...
                case 31: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option19.is_some = true;
                      option19.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                ...
                case 32: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option20.is_some = true;
                      option20.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                ...
                case 38: {
                  platform_option_string_t option21;
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    case 0: {
                      option21.is_some = false;
                      break;
                    ...
                    case 1: {
                      option21.is_some = true;
                      option21.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
      ...
      switch ((int32_t) variant.tag) {
        ...
        case 1: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option2.is_some = true;
              option2.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u16_t option3;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
              option3.is_some = false;
              break;
        ...
        case 22: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option10.is_some = true;
              platform_option_string_t option8;
              switch ((int32_t) *((uint8_t*) (ptr + 20))) {
                case 0: {
                  option8.is_some = false;
                  break;
                ...
                case 1: {
                  option8.is_some = true;
                  option8.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 24))), (*((size_t*) (ptr + 28))) };
                  break;
                }
              }
              platform_option_u32_t option9;
        ...
        case 27: {
          platform_option_string_t option15;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option15.is_some = false;
              break;
            ...
            case 1: {
              option15.is_some = true;
              option15.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
          platform_option_u32_t option16;
        ...
        case 28: {
          platform_option_u64_t option17;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option17.is_some = false;
              break;
        ...
        case 30: {
          ...
          platform_option_u32_t option20;
          switch ((int32_t) *((uint8_t*) (ptr + 28))) {
            case 0: {
              option20.is_some = false;
              break;
        ...
        case 31: {
          ...
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            ...
            case 1: {
              option21.is_some = true;
              option21.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 32: {
          platform_option_string_t option22;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
            ...
            case 1: {
              ...
              option22.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
        ...
        case 38: {
          platform_option_string_t option23;
          switch ((int32_t) *((uint8_t*) (ptr + 16))) {
            case 0: {
              option23.is_some = false;
              break;
            ...
            case 1: {
              option23.is_some = true;
              option23.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 20))), (*((size_t*) (ptr + 24))) };
              break;
            }
          }
              ...
              switch ((int32_t) variant.tag) {
                ...
                case 1: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option.is_some = true;
                      option.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u16_t option0;
                ...
                case 14: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                    ...
                    case 1: {
                      option2.is_some = true;
                      option2.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                      break;
                    }
                  }
                  variant.val.tls_alert_received = (wasi_http_types_tls_alert_received_payload_t) {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      ...
                      switch ((int32_t) *((uint8_t*) (ptr + 36))) {
                        ...
                        case 1: {
                          option5.is_some = true;
                          option5.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 40))), (*((size_t*) (ptr + 44))) };
                          break;
                        }
                      }
                      platform_option_u32_t option6;
                ...
                case 24: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option9.is_some = true;
                      option9.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option10;
                ...
                case 27: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option12.is_some = true;
                      option12.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option13;
                ...
                case 30: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option16.is_some = true;
                      option16.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  platform_option_u32_t option17;
                ...
                case 31: {
                  ...
                  switch ((int32_t) *((uint8_t*) (ptr + 32))) {
                    ...
                    case 1: {
                      option18.is_some = true;
                      option18.val = (platform_string_t) { (uint8_t*)(*((uint8_t **) (ptr + 36))), (*((size_t*) (ptr + 40))) };
                      break;
                    }
                  }
                  variant.val.http_response_transfer_coding = option18;
...
void wasi_random_random_get_random_bytes(uint64_t len, platform_list_u8_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  uint8_t *ptr = (uint8_t *) &ret_area;
  __wasm_import_wasi_random_random_get_random_bytes((int64_t) (len), ptr);
  *ret = (platform_list_u8_t) { (uint8_t*)(*((uint8_t **) (ptr + 0))), (*((size_t*) (ptr + 4))) };
}
