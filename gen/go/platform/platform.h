...
typedef struct {
  bool is_some;
  platform_string_t val;
} platform_option_string_t;

typedef struct {
  bool is_some;
  uint16_t val;
} platform_option_u16_t;

// Defines the case payload type for `DNS-error` above:
typedef struct wasi_http_types_dns_error_payload_t {
  platform_option_string_t   rcode;
  platform_option_u16_t   info_code;
} wasi_http_types_dns_error_payload_t;

typedef struct {
  bool is_some;
  uint8_t val;
} platform_option_u8_t;

// Defines the case payload type for `TLS-alert-received` above:
typedef struct wasi_http_types_tls_alert_received_payload_t {
  platform_option_u8_t   alert_id;
  platform_option_string_t   alert_message;
} wasi_http_types_tls_alert_received_payload_t;

typedef struct {
  bool is_some;
  uint32_t val;
} platform_option_u32_t;

// Defines the case payload type for `HTTP-response-{header,trailer}-size` above:
typedef struct wasi_http_types_field_size_payload_t {
  platform_option_string_t   field_name;
  platform_option_u32_t   field_size;
} wasi_http_types_field_size_payload_t;

typedef struct {
  bool is_some;
  uint64_t val;
} platform_option_u64_t;
...
typedef struct wasi_http_types_error_code_t {
  ...
  union {
    ...
    platform_option_u64_t     http_request_body_size;
    platform_option_u32_t     http_request_header_section_size;
    wasi_http_types_option_field_size_payload_t     http_request_header_size;
    platform_option_u32_t     http_request_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_request_trailer_size;
    platform_option_u32_t     http_response_header_section_size;
    wasi_http_types_field_size_payload_t     http_response_header_size;
    platform_option_u64_t     http_response_body_size;
    platform_option_u32_t     http_response_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_response_trailer_size;
    platform_option_string_t     http_response_transfer_coding;
    platform_option_string_t     http_response_content_coding;
    platform_option_string_t     internal_error;
  } val;
...
typedef platform_string_t wasi_http_types_field_key_t;
...
} platform_tuple2_field_key_field_value_t;

typedef struct {
  platform_tuple2_field_key_field_value_t *ptr;
  size_t len;
} platform_list_tuple2_field_key_field_value_t;
...
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, platform_list_u32_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, platform_string_t *ret);
...
extern void wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, platform_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
// ```
extern void wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, platform_list_u8_t *contents, wasi_io_streams_result_void_stream_error_t *ret);
...
extern void wasi_http_types_static_fields_from_list(platform_list_tuple2_field_key_field_value_t *entries, wasi_http_types_result_own_fields_header_error_t *ret);
// Get all of the values corresponding to a key. If the key is not present
// in this `fields` or is syntactically invalid, an empty list is returned.
// However, if the key is present but empty, this is represented by a list
// with one or more empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, platform_list_field_value_t *ret);
...
extern void wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_key_t *name, platform_list_field_value_t *value, wasi_http_types_result_void_header_error_t *ret);
...
// which have multiple values are represented by multiple entries in this
// list with the same key.
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, platform_list_tuple2_field_key_field_value_t *ret);
...
extern void wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, platform_option_string_t *ret);
...
extern void wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, platform_option_string_t *ret);
...
extern void wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *ret);
// Set the combination of the HTTP Path and Query for the Request.
// When `none`, this represents an empty Path and empty Query. Fails is the
// string given is not a syntactically valid path and query uri component.
extern void wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *path_with_query, wasi_http_types_result_void_void_t *ret);
...
extern void wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *ret);
// Set the HTTP Authority for the Request. A value of `none` may be used
// with Related Schemes which do not require an Authority. The HTTP and
// HTTPS schemes always require an authority. Fails if the string given is
// not a syntactically valid uri authority.
extern void wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, platform_option_string_t *authority, wasi_http_types_result_void_void_t *ret);
// Get the headers associated with the Request.
// 
// The returned `headers` resource is immutable: `set`, `append`, and
// `delete` operations will fail with `header-error.immutable`.
...
extern void wasi_http_types_method_request_options_connect_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret);
// Set the timeout for the initial connect to the HTTP Server. An error
// return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_connect_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving the first byte of the Response body.
extern void wasi_http_types_method_request_options_first_byte_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret);
// Set the timeout for receiving the first byte of the Response body. An
// error return value indicates that this timeout is not supported.
extern void wasi_http_types_method_request_options_set_first_byte_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
// The timeout for receiving subsequent chunks of bytes in the Response
// body stream.
extern void wasi_http_types_method_request_options_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *ret);
// Set the timeout for receiving subsequent chunks of bytes in the Response
// body stream. An error return value indicates that this timeout is not
// supported.
extern void wasi_http_types_method_request_options_set_between_bytes_timeout(wasi_http_types_borrow_request_options_t self, platform_option_duration_t *duration, wasi_http_types_result_void_void_t *ret);
...
// data.
extern void wasi_random_random_get_random_bytes(uint64_t len, platform_list_u8_t *ret);
